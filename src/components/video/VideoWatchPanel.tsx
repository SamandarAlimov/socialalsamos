 ...
 *
 * Yuqorida video o'ynaydi, pastda esa boshqa videolar ro'yxati scroll qilinadi.
 * Foydalanuvchi ro'yxatdan boshqa videoni tanlasa — sahifadan chiqmasdan
 * yuqoridagi pleyer almashadi (YouTube kabi).
 */
    ...
    <div className="fixed inset-0 z-[100] flex flex-col bg-background">
      ...
      <div
        ...
        className={cn(
          ...
          aspectKind === 'portrait' && !isFullscreen && 'md:aspect-video',
        )}
        onPointerMove={revealControls}
        onClick={() => (showControls ? togglePlay() : revealControls())}
      >
      ...
      {/* PASTKI SCROLL: ma'lumot + keyingi videolar */}
      <div ref={scrollRef} className="flex-1 overflow-y-auto overscroll-contain">
        <div className="px-3 pt-3">
          <h1 className="text-[15px] font-semibold leading-snug text-foreground">{title}</h1>
        ...
        {/* Harakatlar */}
        <div className="mt-3 flex gap-2 overflow-x-auto px-3 pb-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
          <button
            type="button"
            onClick={() => {
              onLike(video.id);
        ...
        <button
          ...
          className="mt-3 flex w-full items-center gap-3 border-y border-border px-3 py-3 text-left"
        >
          <StoryAvatar
        ...
        {/* Keyingi videolar */}
        <div className="pb-[calc(env(safe-area-inset-bottom,0px)+88px)] pt-2">
