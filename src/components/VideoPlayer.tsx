...
import { Play, Pause, Volume2, VolumeX, Volume1, Maximize2, Minimize2, Settings, Subtitles, SkipForward, SkipBack, Loader2, ChevronRight, Check, ArrowLeft } from 'lucide-react';
