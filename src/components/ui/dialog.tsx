...
function hasDialogDescription(children: React.ReactNode): boolean {
  ...
  React.Children.forEach(children, (child) => {
    ...
    if (child.props?.children) found = hasDialogDescription(child.props.children);
  });
  return found;
}
...
const DialogContent = React.forwardRef<
  ...
  DialogContentProps
>(({ className, children, hideDefaultClose = false, overlayClassName, overlayStyle, ...props }, ref) => {
      ...
      >
        {!hasDescription && (
          <DialogPrimitive.Description className="sr-only">
            Ushbu oynada qo‘shimcha amal va sozlamalar mavjud.
