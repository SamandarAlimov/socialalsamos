...
import { ImageIcon, Video, Camera, BarChart3, MapPin, AtSign, Hash, Smile, Mic, Calendar, Music, Users, Type, Sparkles, Sticker, Link2, FileText, Wand2 } from 'lucide-react';
