...
import { X, ChevronLeft, ChevronRight, Send, Heart, Share2, Smile, Eye, Trash2, MoreHorizontal, Pause, Play, Bookmark, Loader2, Download, Flag, Volume2, VolumeX } from 'lucide-react';
