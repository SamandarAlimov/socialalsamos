        ...
        <nav className="min-w-0 space-y-0.5 overflow-hidden">
          <div className="min-w-0 rounded-xl">
            ...
            <div className="mt-1 min-w-0 space-y-0.5">
              {projects.map((project) => {
                ...
                return (
                  <div key={project.id} className="min-w-0 overflow-hidden">
                    <div
                      className={cn(
                        'group/project flex min-w-0 items-center overflow-hidden rounded-xl transition-colors hover:bg-muted/55',
                    ...
                    >
                      <button
                        ...
                        className="flex w-0 min-w-0 flex-1 items-center gap-2.5 overflow-hidden px-2.5 py-2 text-left text-[13px]"
                      >
                      ...
                      {onNewProject && (
                        <Button
                          ...
                          size="icon"
                          variant="ghost"
                          className="h-7 w-7 shrink-0 rounded-lg text-muted-foreground opacity-60 hover:opacity-100 group-hover/project:opacity-100"
                          onClick={(event) => {
                            event.stopPropagation();
                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button
                              size="icon"
                              variant="ghost"
                              className="mr-0.5 h-7 w-7 shrink-0 rounded-lg text-muted-foreground opacity-50 hover:opacity-100 group-hover/project:opacity-100"
                    ...
                    {expanded && (
                      <div className="ml-7 min-w-0 space-y-0.5 border-l border-border/45 pl-2">
              ...
              {projects.length === 0 && (
                <p className="px-2.5 py-1.5 text-[11px] text-muted-foreground">Hozircha loyiha yo‘q</p>
              )}
            </div>
          </div>
