...
const COUNTRIES: Array<{ value: string; label: string }> = [
  ...
  { value: 'US', label: '🇺🇸 AQSH' },
  { value: 'GB', label: '🇬🇧 Buyuk Britaniya' },
  { value: 'DE', label: '🇩🇪 Germaniya' },
  { value: 'FR', label: '🇫🇷 Fransiya' },
  { value: 'IT', label: '🇮🇹 Italiya' },
  { value: 'ES', label: '🇪🇸 Ispaniya' },
  { value: 'KR', label: '🇰🇷 Janubiy Koreya' },
  { value: 'JP', label: '🇯🇵 Yaponiya' },
  { value: 'CN', label: '🇨🇳 Xitoy' },
  { value: 'IN', label: '🇮🇳 Hindiston' },
  { value: 'AE', label: '🇦🇪 BAA' },
  { value: 'SA', label: '🇸🇦 Saudiya Arabistoni' },
