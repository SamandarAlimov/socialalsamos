...
import { ArrowLeft, Check, ImagePlus, Loader2, RotateCcw } from 'lucide-react';
...
/** Sozlamalar > Chat foni (Telegramdagi "Chat Background" kabi) */
        ...
        <div className="space-y-5">
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm">
              ...
              <span className="text-muted-foreground">{Math.round(wallpaper.dim * 100)}%</span>
            </div>
            <Slider
